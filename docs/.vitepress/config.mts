...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/DogeLakeDev' },
      { icon: {
    ...
    footer: {
      message: '<a href="https://icp.gov.moe/?keyword=20250122" target="_blank">萌ICP备20250122号</a> <a href="https://beian.miit.gov.cn" id="beian" target="_blank">闽ICP备2023018495号-2</a>',
      copyright: 'Copyright © 2025 东方犬明湖'
    }
  }
})
